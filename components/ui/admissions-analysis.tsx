...
export function AdmissionsAnalysis() {
  return (
    <div className="w-full py-12 md:py-24 lg:py-32 bg-muted/30">
      <div className="container px-4 md:px-6">
        <div className="flex flex-col items-center text-center space-y-4 mb-12">
          <Badge variant="outline" className="mb-2">Comprehensive Analysis</Badge>
        ...
        <Tabs defaultValue="contact" className="w-full">
            ...
            <Card>
              ...
              <CardContent className="space-y-4">
                <div className="grid grid-cols-1 md:grid-cols-3 gap-4">
                  <div className="flex flex-col items-center p-4 bg-background rounded-lg border shadow-sm">
          ...
          <TabsContent value="programs" className="space-y-4">
            <Card>
              <CardHeader>
                <CardTitle>Educational Programs and Offerings</CardTitle>
                <CardDescription>
          ...
          <TabsContent value="fees" className="space-y-4">
            <Card>
              <CardHeader>
                <CardTitle>Fee Structure for Computer Science Program</CardTitle>
                <CardDescription>
                  ...
                  <table className="w-full border-collapse">
                    <thead>
                      <tr className="bg-muted">
                        ...
                        <th className="border px-4 py-2 text-right">Total Fee (PKR)</th>
                      </tr>
                    </thead>
                    <tbody>
                      <tr>
                        <td className="border px-4 py-2 font-medium">University of Lahore (UOL)</td>
                        <td className="border px-4 py-2 text-right">13,51,000</td>
                      </tr>
                      <tr className="bg-muted/50">
                        <td className="border px-4 py-2 font-medium">University of Management & Technology (UMT)</td>
                        <td className="border px-4 py-2 text-right">16,90,000</td>
                      </tr>
                      <tr>
                        <td className="border px-4 py-2 font-medium">University of Central Punjab (UCP)</td>
                        <td className="border px-4 py-2 text-right">16,21,000</td>
                      </tr>
                      <tr className="bg-muted/50">
                        <td className="border px-4 py-2 font-medium">Superior University</td>
                        <td className="border px-4 py-2 text-right">13,37,000</td>
                      </tr>
                    </tbody>
                  </table>
                </div>
          ...
          <TabsContent value="location" className="space-y-4">
            <Card>
              <CardHeader>
                <CardTitle>Campus Location Considerations</CardTitle>
                <CardDescription>
          ...
          <TabsContent value="grading" className="space-y-4">
            <Card>
              <CardHeader>
                <CardTitle>Grading System and Academic Structure</CardTitle>
                <CardDescription>
                      ...
                      <table className="w-full border-collapse">
                        <thead>
                          <tr className="bg-muted">
                            ...
                            <th className="border px-4 py-2">GPA Value</th>
                          </tr>
                        </thead>
                        <tbody>
                          <tr>
                            <td className="border px-4 py-2 font-medium">A</td>
                            <td className="border px-4 py-2">4.00</td>
                          </tr>
                          <tr className="bg-muted/50">
                            <td className="border px-4 py-2 font-medium">B</td>
                            <td className="border px-4 py-2">3.00</td>
                          </tr>
                          <tr>
                            <td className="border px-4 py-2 font-medium">C</td>
                          ...
                          <tr>
                            <td className="border px-4 py-2 font-medium">F</td>
